...
import VideoList from "../basis/VideoList";
import VideoSearch from "../basis/VideoSearch";
...
function YouVideo() {
  ...
  const search = (query) => {
    ...
    fetch(
      `https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyDuRMrAzP2cIY7NE5NZvNw6wyztoqRkZDU&part=snippet&q=bts&type=video&key=AIzaSyDuRMrAzP2cIY7NE5NZvNw6wyztoqRkZDU`,
      requestOptions
    )
  ...
  useEffect(() => {
    ...
    fetch(
      "https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyDuRMrAzP2cIY7NE5NZvNw6wyztoqRkZDU&part=snippet&q=webstoryboy&type=video&key=AIzaSyDuRMrAzP2cIY7NE5NZvNw6wyztoqRkZDU",
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => setVideos(result.items))
